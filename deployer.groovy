		...
		stage('DOCKER PROCESSING')
		{
			steps
			{
				script
				{
					...
					{
						ansiblePlaybook become: true, credentialsId: 'ubuntu-private', disableHostKeyChecking: true, extras: "-e \"host=$APP_NAME\"", installation: 'ansible-new', inventory: 'inventory', playbook: 'deploy.yml'
					}
				}
			}
